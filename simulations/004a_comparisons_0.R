...
saveRDS(atmle_both_res,
        file = "out/atmle_both_0_bias_glm_lasso_" %+% format(Sys.time(), "%Y%m%d_%H%M%S") %+% ".RDS")
...
saveRDS(atmle_tmle_res,
        file = "out/atmle_tmle_0_bias_glm_lasso_" %+% format(Sys.time(), "%Y%m%d_%H%M%S") %+% ".RDS")
...
saveRDS(escvtmle_res,
        file = "out/escvtmle_0_bias_glm_lasso_" %+% format(Sys.time(), "%Y%m%d_%H%M%S") %+% ".RDS")
...
#                                method = "tmle")
# saveRDS(tmle_res,
#         file = "out/tmle_0_bias_glm_lasso_" %+% format(Sys.time(), "%Y%m%d_%H%M%S") %+% ".RDS")
