...
ggsave(filename = "no_bias_913.pdf", plot = plt_no_bias, device = "pdf",
...
ggsave(filename = "constant_bias_913.pdf", plot = plt_constant_bias, device = "pdf",
       path = "plot", width = 10, height = 8, dpi = 300)
...
ggsave(filename = "param_simple_bias_913.pdf", plot = plt_param_simple_bias, device = "pdf",
       path = "plot", width = 10, height = 8, dpi = 300)

# d. complex parametric bias -------------------------------------------------------------
#atmle_both_res <- readRDS("out/atmle_both_param_complex_glm_lasso_20230913_143429.RDS")
#atmle_tmle_res <- readRDS("out/atmle_tmle_param_complex_glm_lasso_20230915_015357.RDS")
