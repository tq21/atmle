...
# a. no bias -------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_0_bias_glm_glmnet_1003.RDS")
atmle_tmle_res <- readRDS("out/atmle_tmle_0_bias_glm_glmnet_1003.RDS")
escvtmle_res <- readRDS("out/escvtmle_0_bias_glm_glmnet_1003.RDS")
rct_only_res <- readRDS("out/rct_only_0_bias_glm_glmnet_1003.RDS")
...
# b. constant bias -------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_1.8_bias_glm_glmnet_1003.RDS")
atmle_tmle_res <- readRDS("out/atmle_tmle_1.8_bias_glm_glmnet_1003.RDS")
escvtmle_res <- readRDS("out/escvtmle_1.8_bias_glm_glmnet_1003.RDS")
rct_only_res <- readRDS("out/rct_only_1.8_bias_glm_glmnet_1003.RDS")
...
atmle_both_res <- readRDS("out/atmle_both_param_simple_glm_glmnet_1003.RDS")
atmle_tmle_res <- readRDS("out/atmle_tmle_param_simple_glm_glmnet_1003.RDS")
escvtmle_res <- readRDS("out/escvtmle_param_simple_glm_glmnet_1003.RDS")
rct_only_res <- readRDS("out/rct_only_param_simple_glm_glmnet_1003.RDS")
...
atmle_both_res <- readRDS("out/atmle_both_param_complex_glm_glmnet_1003.RDS")
atmle_tmle_res <- readRDS("out/atmle_tmle_param_complex_glm_glmnet_1003.RDS")
escvtmle_res <- readRDS("out/escvtmle_param_complex_glm_glmnet_1003.RDS")
rct_only_res <- readRDS("out/rct_only_param_complex_glm_glmnet_1003.RDS")
