sim_rct <- function(ate, n, rct_prop, g_rct, bias, controls_only) {
  # error
  UY <- rnorm(n, 0, 1)
  U_bias <- rnorm(n, 0, 1)
...
sim_rwd <- function(ate, n, rct_prop, g_rct, bias, controls_only) {
  # error
  UY <- rnorm(n, 0, 1)
  U_bias <- rnorm(n, 0, 1)

  # baseline covariates
  W1 <- rnorm(n, 0, 3)# runif(n, 0, 1) #
  W2 <- rnorm(n, 0, 3)# runif(n, 0, 1) #
  W3 <- rnorm(n, 0, 3)# runif(n, 0, 1) #
  W4 <- rnorm(n, 0, 3)# runif(n, 0, 1) #
