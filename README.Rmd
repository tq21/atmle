...
This package exposes the `atmle_ate_fusion` R6 estimator for adaptive targeted
minimum loss-based estimation of average treatment effects using combined
randomized trial and real-world data.

## Example

```{r atmle-ate-fusion-example, message=FALSE, warning=FALSE}
library(atmle)
library(sl3)
