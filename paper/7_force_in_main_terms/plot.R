...
# bias a -----------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_a_bias_0421.RDS")
escvtmle_res <- readRDS("out/escvtmle_a_bias_0421.RDS")
tmle_res <- readRDS("out/tmle_a_bias_0421.RDS")
rct_only_res <- readRDS("out/rct_only_a_bias_0421.RDS")
...
# bias b -----------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_b_bias_0421.RDS")
escvtmle_res <- readRDS("out/escvtmle_b_bias_0421.RDS")
tmle_res <- readRDS("out/tmle_b_bias_0421.RDS")
rct_only_res <- readRDS("out/rct_only_b_bias_0421.RDS")
...
ggsave(filename = "force_main_terms.pdf", plot = plt, device = "pdf",
