...
# b. small bias -------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_small_bias_1229.RDS")
escvtmle_res <- readRDS("out/escvtmle_small_bias_1229.RDS")
tmle_res <- readRDS("out/tmle_small_bias_1229.RDS")
plt_param_simple_bias <- get_plot(
  "Small bias",
  c("A-TMLE", "ESCVTMLE", "TMLE"),
  atmle_both_res, escvtmle_res, tmle_res)
...
# c. large bias -------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_large_bias_1229.RDS")
escvtmle_res <- readRDS("out/escvtmle_large_bias_1229.RDS")
tmle_res <- readRDS("out/tmle_large_bias_1229.RDS")
