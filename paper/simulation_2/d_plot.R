...
# a. no bias -------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_HAL_1_1229.RDS")
escvtmle_res <- readRDS("out/escvtmle_HAL_1_1229.RDS")
tmle_res <- readRDS("out/tmle_HAL_1_1229.RDS")
plt_HAL_1 <- get_plot(
  "Complex bias 1",
  c("A-TMLE", "ES-CVTMLE", "TMLE"),
  atmle_both_res, escvtmle_res, tmle_res)
ggsave(filename = "complex_bias_1.pdf", plot = plt_no_bias, device = "pdf",
...
# b. small bias -------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_HAL_2_1229.RDS")
escvtmle_res <- readRDS("out/escvtmle_HAL_2_1229.RDS")
tmle_res <- readRDS("out/tmle_HAL_2_1229.RDS")
...
# c. large bias -------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_HAL_3_1229.RDS")
escvtmle_res <- readRDS("out/escvtmle_HAL_3_1229.RDS")
tmle_res <- readRDS("out/tmle_HAL_3_1229.RDS")
