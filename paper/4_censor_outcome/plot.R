...
n_rwd_seq <- n_rct_seq * 4
total_sample_sizes <- n_rct_seq + n_rwd_seq
ate <- 1.5

# bias a -----------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_a_bias_0225.RDS")
escvtmle_res <- readRDS("out/escvtmle_a_bias_0225.RDS")
tmle_res <- readRDS("out/tmle_a_bias_0225.RDS")
rct_only_res <- readRDS("out/rct_only_a_bias_0225.RDS")
...
# bias b -----------------------------------------------------------------------
atmle_both_res <- readRDS("out/atmle_both_b_bias_0225.RDS")
escvtmle_res <- readRDS("out/escvtmle_b_bias_0225.RDS")
tmle_res <- readRDS("out/tmle_b_bias_0225.RDS")
rct_only_res <- readRDS("out/rct_only_b_bias_0225.RDS")
...
ggsave(filename = "param_ext_controls.pdf", plot = plt, device = "pdf",
